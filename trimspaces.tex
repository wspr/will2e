...
\end{itemize}
The first is fully expandable and removes any surrounding spaces from \meta{text}.
The second is a variant that after full expansion results in the original, unexpanded, text stripped of any surrounding spaces.
The last re-defines \meta{macro} as itself stripped of any surrounding spaces
...
\edef\aa{\trim@spaces@noexp{ a \foo ! }}
\def\b{ b \foo ! }
\trim@spaces@in\b
